...
def get_content(f_name):
    ...
    # 给登录框与密码赋值
    driver.find_element_by_id('loginname').send_keys(config.WEIBO_USERNAME)
    driver.find_element_by_class_name('password').find_element_by_name('password').send_keys(config.WEIBO_PASSWORD)
