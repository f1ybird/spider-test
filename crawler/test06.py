...
# 账号输入框输入已知qq账号
driver.find_element_by_id("u").send_keys(config.QQ_USERNAME)

# 密码框输入已知密码
driver.find_element_by_id("p").send_keys(config.QQ_PASSWORD)

# 此处延迟5秒，否则太快导致识别为机器人无法登陆
time.sleep(5)
...
driver.get("http://user.qzone.qq.com/" + config.QQ_FRIEND + "/311")
